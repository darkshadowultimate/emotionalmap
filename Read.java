 ...
 * Read class provides several method to read from three specific type of files: "comandi.txt", "eventi.txt", "poi.txt" (these are the theorical names except "poi.txt").
 */
public class Read {
